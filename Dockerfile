...
RUN apt-get -qq update && apt-get -qq install -t testing -y cloudcompare pdal binutils libproj-dev gdal-bin nginx certbot grass-core && apt-get -qq install -y gettext-base cron postgresql-client-9.6
