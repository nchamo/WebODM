          ...
          <div className="row">
            <div className="col-md-3 no-padding">
              ...
              {task.import_album && task.import_album != -1 ?
                <div className="labels">
                  <strong>Imported from Piwigo: </strong> <a href={window.location.protocol + "//imagenes." + window.location.hostname + "/index.php?/category/" + task.import_album} target="_blank">Go to album</a><br/>
                </div>
              : ""}
              {/* TODO: List of images? */}
